-- ============================================================
-- DAY 3 - SCRIPT SQL COMPLET POUR EXÉCUTION
-- Plateforme Web du Laboratoire LR16CNSTN02
-- ============================================================
...
-- Équipe 1 : Techniques Radiochimiques
...
-- Équipe 3 : Modélisation Physique des Systèmes Nucléaires
INSERT INTO teams (name, description, expertise, objectives, display_order) VALUES
(
...
-- Équipe 4 : Instrumentation Nucléaire Haute Résolution
INSERT INTO teams (name, description, expertise, objectives, display_order) VALUES
(
...
SELECT '=== INFORMATIONS DU LABORATOIRE ===' AS '';
SELECT * FROM lab_info;

-- Afficher les équipes
SELECT '=== LES 4 ÉQUIPES DE RECHERCHE ===' AS '';
SELECT id, name, display_order FROM teams ORDER BY display_order;

-- ============================================================
-- FIN DU SCRIPT SQL DAY 3
-- ============================================================
